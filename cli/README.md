...
3. PIIANO_CS_DB_OPTIONS - Possible values are auto / default/ custom - Instructions how to build internal code database
4. PIIANO_CS_BUILD_COMMAND - In case custom was chosen, the command used to build the source repo. 
